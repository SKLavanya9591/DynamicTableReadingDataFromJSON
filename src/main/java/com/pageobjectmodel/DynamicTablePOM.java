...
public class DynamicTablePOM {
	...
	DataExtractionHelper data = new DataExtractionHelper();
	static Logger logger = Logger.getLogger(DynamicTablePOM.class.getName());
 ...
 */
	...
	public void insertValuesIntoTheTable()
		...
		Object data = DataExtractionHelper.getRawJsonData(jsonFilePath);
	...
	public void assertTheInsertedValues() {
		List<Person> tableDetails = DataExtractionHelper.getDataFromJSON(jsonFilePath);
		...
		try {
			...
			System.out.println("All the values are inserted into the table are matching with json file - PASSED");
		} catch (Exception e) {
